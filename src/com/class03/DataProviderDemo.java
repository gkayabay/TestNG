...
public class DataProviderDemo extends CommonMethods {
	...
	public void login(String username, String password, int age) { // it will get the username and password from
																	// dataprovider
	...
	// The coloumns of each row are bound/pass as parameter to Test Case
	@DataProvider // provides data for the test above and has @DataProvider Annotation, should
					// return 2D Array
	public Object[][] getData() {
		...
		Object[][] data = { { "Admin", "Hum@nhrm123", 23 }, 
				            { "Syntax", "Syntax123!", 25 },
